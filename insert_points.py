...
for s in vars.seasons:
    for i in range(1, s["games"]+1):
        ...
        print g.gameID, g.seasonID, g.yearID
        try:
            for k,v in g.homeTeamSkaters.iteritems():
                proc_vars = [   g.seasonID, 
                                g.gameID, 
                                g.yearID[0:4], 
                                v["nhl_id"],
                                v["goals"],
                                ...
                                v["plusminus"],
                                v["shorthandedgoals"],
                                v["shorthandedassists"],
                                v["gamewinningassists"],
                                v["emptynetassists"],
                                v["powerplaygoals"],
                                v["powerplayassists"],
                                v["gamewinninggoals"],
                                ...
                                v["takeaways"],
                                v["faceoffwins"],
                                v["faceofflosses"],"'" + str(v["timeonice"]) + "'",
                                v["shootoutgoals"],
                                v["shootoutmisses"],
                                v["wins"],
                                v["otlosses"],
                                ...
                                v["shutouts"],
                                v["penaltyshotsaves"],
                                v["penaltyshotgoalsagainst"],
                                v["shootoutsaves"],
                                v["shootoutgoalsagainst"],
                                v["goalsagainst"],
                                v["firststars"],
                                v["secondstars"],
                                v["thirdstars"]]
